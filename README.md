...
[ENG] This is a [PocketMine-MP](https://github.com/pmmp/PocketMine-MP) (or forks) plugin allows to have a Lobby System in 1 single plugin ! ! :grin: <br/>
<br/>
[FRA] C'est un [PocketMine-MP](https://github.com/pmmp/PocketMine-MP) plugin qui vous permet d'avoir un Système de Lobby dans 1 seul plugin ! :grin: <br/>

---
### How to use
[ENG] Configure the config.yml</br>
